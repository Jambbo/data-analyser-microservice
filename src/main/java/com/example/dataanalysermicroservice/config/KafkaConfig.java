...
public class KafkaConfig {
    ...
    private String servers; // строка с серверами кафки
    ...
    //бин с пропертями для конфигурации
    @Bean
    public Map<String,Object> receiverProperties(){
        ...
        props.put(
                "spring.json.trusted.packages", // чтобы можно было нормально работать с пакетами в приложении и норм их обрабатывать
                new TextXPath(
    ...
    public ReceiverOptions<String,Object> receiverOptions(){
        ...
        return receiverOptions.subscription(topics)
                ...
                .addRevokeListener( partitions -> /* когда партишены отключаются*/
                        System.out.println("assigned: "+partitions)
                );
    }
